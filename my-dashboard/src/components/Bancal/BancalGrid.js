...
const BancalGrid = ({ grid, addRow, addColumn, removeRow, removeColumn, handleCellClick, hoveredRow, setHoveredRow, hoveredColumn, setHoveredColumn }) => (
